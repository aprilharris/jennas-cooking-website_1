...
let url = "https://api.spoonacular.com/recipes/random?apiKey=7db1baf9ccbb44a78234fabcb60e7f5f&tags=vegan";
...
function fetchRecipes(){
  ...
  request.onload = function() { //Once we recieve the response do this vvvv
    ...
    if (request.status >= 200 && request.status < 400) {
      ...
      $(".result").html(resTitle)
      $('.recipe-image').attr('src',recipe_img);
